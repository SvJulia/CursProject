...
namespace CursProject
{
    ...
    partial void OnTypeChanged();
        ...
        public override string ToString()
        {
            return string.Format("{0} - {1}", Name, EnumHelper.Huminize(EnumHelper.FromString<HotelType>(Type)));
        }
	}
    ...
    partial void OnTypeChanged();
        ...
        public override string ToString()
        {
            return string.Format("{0} - {1}", Name, EnumHelper.Huminize(EnumHelper.FromString<MealType>(Type)));
        }
	}
    ...
    partial void OnCityIdChanged();
        ...
        public override string ToString()
        {
            return string.Format("{0}. {1}, {2}", Name, City.Country, City);
        }
	}
    ...
    partial void OnTypeChanged();
        ...
        public override string ToString()
        {
            return string.Format("{0} - {1}", Name, EnumHelper.Huminize(EnumHelper.FromString<TransportType>(Type)));
        }
	}
